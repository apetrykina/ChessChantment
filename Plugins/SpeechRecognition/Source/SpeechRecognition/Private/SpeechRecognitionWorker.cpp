...
void FSpeechRecognitionWorker::SetModelDirPath(FString modelDirPath)
{
	if (!modelDirPath.IsEmpty() && FPaths::DirectoryExists(modelDirPath))
	{
		contentPath_str = std::string(TCHAR_TO_UTF8(*modelDirPath));
	}
}
